...
const Navbar = ({ sidebarOpen, onMenuButtonClick }: Props) => {
  return (
    <nav className='lg:hidden fixed top-0 left-0 z-30  w-full h-[50px] flex justify-between lg:justify-center items-center bg-slate-700 border-b border-slate-500' >
